...
export const morningSteps: SkincareStep[] = [
  ...
  },
  {
    ...
    summary:
      "Antioxidant shield before sun exposure- stimulates collagen and reduces dark spots.",
  ...
  },
  {
    ...
    evidence:
      "Ceramides achieved 82.1% consensus and petrolatum 85.5% for dry skin in the 2025 JAAD study. Hyaluronic acid reached 79% consensus as a universal hydrating ingredient.",
    usage:
      "Choose formula based on skin type: lightweight gel for oily, richer ceramide cream for dry or mature skin. Apply in upward motions before SPF. Use daily.",
    timeSlot: "morning",
    when: "morning",
  },
  {
    ...
    usage:
      "SPF 30 minimum, broad-spectrum (UVA + UVB). Apply 2 finger-lengths for the face. Reapply every 2 hours when outdoors. Mineral sunscreens (zinc oxide, titanium dioxide) are suitable for all skin types including sensitive.",
    timeSlot: "morning",
    when: "morning",
  },
];
...
export const nightSteps: SkincareStep[] = [
  {
    ...
    summary:
      "Remove the day's sunscreen, pollution, and sebum before your actives can work.",
    ...
    evidence:
      "AAD and 2025 JAAD consensus position the cleansing step as foundational to all other night routine actives.",
    usage:
      "If SPF or makeup was worn: oil-based cleanser first (balm, cleansing oil), massage 60 seconds, rinse, then follow with a gentle water-based cleanser. If no SPF or makeup: single low-pH cleanser is sufficient.",
    timeSlot: "night",
    when: "night",
  },
  {
    ...
    summary:
      "Retinoids are the most-evidenced night active. Chemical exfoliants on alternate nights.",
  ...
  },
  {
    ...
    summary:
      "Night is when TEWL peaks and the skin barrier repairs itself- use a heavier formula.",
    ...
    evidence:
      "2025 JAAD consensus: ceramides are the highest-consensus moisturising ingredient for both dry skin (82.1%) and barrier repair. Petrolatum is the gold standard occlusive (85.5% consensus for dry skin).",
    usage:
      "Use a slightly richer formula than your morning moisturiser. For very dry or compromised skin: apply a thin layer of petrolatum or a ceramide balm over your moisturiser (slugging). Avoid fragrance in the night moisturiser.",
    timeSlot: "night",
    when: "night",
  },
];
...
export const skinTypeGuides: SkinTypeGuide[] = [
  ...
  },
  {
    ...
    prioritise: [
      "Azelaic acid",
      "Niacinamide 5%",
      "Retinaldehyde (gentler retinoid)",
      "Mineral SPF",
    ],
    avoid: [
      "Fragrance",
