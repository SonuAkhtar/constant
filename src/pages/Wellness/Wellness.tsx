...
function SkincareIcon() {
  return (
    ...
    >
      <path
        d="M8 2C8 2 4 6 4 9.5a4 4 0 008 0C12 6 8 2 8 2z"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
...
function WorkoutIcon() {
  return (
    ...
    >
      <path
        d="M9 2L4.5 8.5H8L7 14l6.5-8H10L11.5 2z"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export default function Wellness() {
  ...
  return (
    <div className="wellness-page">
      ...
      <div
        className="wellness-page__tab-bar"
        role="tablist"
      ...
      >
        {TABS.map(({ id, label, Icon }) => (
          <button
            ...
            className={[
              "wellness-page__tab",
              tab === id ? "wellness-page__tab--active" : "",
            ].join(" ")}
          ...
          >
            ...
            <span className="wellness-page__tab-icon">
              <Icon />
            </span>
