...
function SunriseIcon() {
  return (
    ...
    >
      <path
        d="M10 4V2M4.4 5.6l-1.1-1.1M2 10H1M19 10h-1M15.6 5.6l1.1-1.1"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
      />
      <path
        d="M5 13a5 5 0 0 1 10 0"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
      />
...
function SunIcon() {
  return (
    ...
    >
      ...
      <path
        d="M10 2v1.5M10 16.5V18M2 10h1.5M16.5 10H18M4.1 4.1l1 1M14.9 14.9l1 1M14.9 5.1l1-1M4.1 15.9l1-1"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
      />
...
function DaytimeIcon({ id }: { id: string }) {
  ...
  if (id === "no-face-touch")
    return (
      ...
      >
        <path
          d="M7 9V5a1.5 1.5 0 013 0v4M10 9V4a1.5 1.5 0 013 0v5M7 9V6a1.5 1.5 0 00-3 0v4c0 4 2 7 6 7s6-3 6-7V9"
          stroke="currentColor"
          strokeWidth="1.5"
          strokeLinecap="round"
          strokeLinejoin="round"
  ...
  if (id === "low-gi")
    return (
      ...
      >
        <path
          d="M10 3C10 3 7 6 6 9c-1 3 1 5 4 5s5-2 4-5c-1-3-4-6-4-6z"
          stroke="currentColor"
          strokeWidth="1.5"
          strokeLinecap="round"
          strokeLinejoin="round"
...
function SkinTypeIcon({ type }: { type: string }) {
  ...
  if (type === "dry")
    return (
      ...
      >
        <path
          d="M10 2v16M7 5h6M6 9h8M7 13h6M8 17h4"
          stroke="currentColor"
          strokeWidth="1.6"
          strokeLinecap="round"
        />
  ...
  if (type === "sensitive")
    return (
      ...
      >
        <path
          d="M10 2l1.5 4H16l-3.5 2.5 1.5 4L10 10l-4 2.5 1.5-4L4 6h4.5L10 2z"
          stroke="currentColor"
          strokeWidth="1.4"
          strokeLinejoin="round"
        />
  ...
  if (type === "mature")
    return (
      ...
      >
        ...
        />
        <path
          d="M10 4V2M10 18v-2M4 10H2M18 10h-2M5.6 5.6l-1.4-1.4M15.8 15.8l-1.4-1.4M14.4 5.6l1.4-1.4M4.2 15.8l1.4-1.4"
          stroke="currentColor"
          strokeWidth="1.4"
          strokeLinecap="round"
        />
...
function StepCard({ step, index }: { step: SkincareStep; index: number }) {
  ...
  return (
    <div
      className={["skincare__step", open ? "skincare__step--open" : ""].join(
        " ",
      )}
    >
      <button
      ...
      >
        ...
        <span className="skincare__step-title-group">
          ...
          {!open && (
            <span className="skincare__step-summary">{step.summary}</span>
          )}
        </span>
    ...
    >
      ...
      >
        ...
        <span className="skincare__supp-top-right">
          <span
            className={["skincare__ev", STRENGTH_CLASS[supp.strength]].join(
              " ",
            )}
          >
...
export default function Skincare() {
  ...
  return (
    <div className="skincare">
      ...
      >
        <h2 className="skincare__section-title" id="sc-skintype-heading">
          Your Skin Type
        </h2>
        <p className="skincare__section-sub">
          Select yours to see personalised guidance.
        </p>
        <div
          className="skincare__skin-chips"
          role="group"
        ...
        >
          {skinTypeGuides.map((guide) => (
            <button
              ...
              onClick={() =>
                setSkinType(skinType === guide.type ? null : guide.type)
              }
      ...
      >
        <div className="skincare__section-header">
          ...
          <div>
            <h2 className="skincare__section-title" id="sc-morning-heading">
              Morning Routine
            </h2>
        ...
        <div className="skincare__principle-note">
          Less is more. You always need sunscreen. Use moisturiser if you need
          it, then one or two other products for specific concerns- 2025 JAAD
          Delphi Consensus (62 dermatologists)
        </div>
      </section>
      ...
      <section className="skincare__section" aria-labelledby="sc-night-heading">
        <div className="skincare__section-header">
          ...
          <div>
            <h2 className="skincare__section-title" id="sc-night-heading">
              Night Routine
            </h2>
      ...
      >
        <div className="skincare__section-header">
          ...
          <div>
            <h2 className="skincare__section-title" id="sc-daytime-heading">
              Daytime Habits
            </h2>
            <p className="skincare__section-sub">
              Simple behaviours that compound over time
            </p>
          </div>
        </div>
        <ul className="skincare__daytime">
          {daytimeHabits.map((habit) => (
            <li key={habit.id} className="skincare__daytime-item">
              <span className="skincare__daytime-icon">
                <DaytimeIcon id={habit.id} />
              </span>
      ...
      <section className="skincare__section" aria-labelledby="sc-supps-heading">
        <div className="skincare__section-header">
          ...
          <div>
            <h2 className="skincare__section-title" id="sc-supps-heading">
              Supplements
            </h2>
            <p className="skincare__section-sub">
              Graded by evidence strength · tap to expand
            </p>
          </div>
        </div>
        <p className="skincare__supp-disclaimer">
          Supplements support a good routine. They do not replace topical care
          or SPF.
        </p>
